...
class TerraformLSPPlugin(AbstractPlugin):
    ...
    def can_start(cls, window: sublime.Window, initiating_view: sublime.View,
                  workspace_folders: List[str], configuration: Dict) -> Optional[str]:
    ...
    @classmethod
    def get_initialize_params(cls, configuration: dict, workspace_folders: List[str]) -> dict:
        """Get additional initialization parameters"""
        params = {
            "processId": os.getpid(),
            "clientInfo": {
                "name": "Sublime Text Terraform",
                "version": "1.0.0"
            },
            "trace": "off",
            "workspaceFolders": [
